...
final class BrowserVersionMapper
{
    ...
    public function mapBrowserVersion(string | null $browserVersion): VersionInterface
    {
        ...
        return match (mb_strtolower($browserVersion)) {
            ...
            '8621.2', '8621.1', '8620.2', '8620.1', '8619.2', '8619.1', '8618.9', '8618.8', '8618.7', '8618.6', '8618.5', '8618.4', '8618.3', '8618.2', '8618.1', '8617.2', '8617.1', '8616.2', '8616.1', '8615.8', '8615.7', '8615.6', '8615.5', '8615.4', '8615.3', '8613.7', '8613.1', '8612.4', '8612.3', '8612.2', '8612.1' => $versionBuilder->set(
                '6.0',
            ),

...
final class DeviceMarketingnameMapper
{
    ...
    public function mapDeviceMarketingName(string | null $marketingName): string | null
    {
        ...
        return match (mb_strtolower($marketingName)) {
            ...
            'galaxy note 3', 'galaxy note 3 lte (t-mobile)', 'galaxy note 3 lte (verizon)', 'galaxy note 3 lte' => 'Galaxy Note 3',
            ...
            'galaxy tab 4 10.1" wi-fi', 'galaxy tab 4 10.1" wifi' => 'Galaxy Tab 4 10.1" Wi-Fi',
            ...
            'kindle fire hdx 7" wifi', 'kindle fire hdx 7" (2013, wi-fi)' => 'Kindle Fire HDX 7" WiFi',

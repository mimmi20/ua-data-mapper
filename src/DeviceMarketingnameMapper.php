...
final class DeviceMarketingnameMapper
{
    ...
    public function mapDeviceMarketingName(string | null $marketingName): string | null
    {
        ...
        return match (mb_strtolower($marketingName)) {
            ...
            'galaxy tab s6 lite 10.4"', 'galaxy tab s6 lite 10.4" wifi', 'galaxy tab s6 lite 10.4" wi-fi (2024)', 'galaxy tab s6 lite 10.4" wi-fi (2022)', 'galaxy tab s6 lite 10.4" lte (2022)', 'galaxy tab s6 lite 10.4" lte', 'galaxy tab s6 lite 10.4" wi-fi', 'galaxy tab s6 lite 10.4" (2024) wifi' => 'Galaxy Tab S6 Lite 10.4"',

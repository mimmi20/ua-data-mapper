...
final class DeviceMarketingnameMapper
{
    ...
    public function mapDeviceMarketingName(string | null $marketingName): string | null
    {
        ...
        return match (mb_strtolower($marketingName)) {
            ...
            'galaxy a03s', 'galaxy a03s 4g', 'galaxy a03s 4g (usa)', 'galaxy a03s 4g (canada)' => 'Galaxy A03s',
            ...
            'galaxy m12', 'galaxy m12 4g (europe)' => 'Galaxy M12',
            ...
            'galaxy s10e', 'galaxy s10e (europe, latin america)' => 'Galaxy S10e',
            ...
            'galaxy s22 ultra', 'galaxy s22 ultra 5g (international)', 'galaxy s22 ultra 5g (asia/africa)', 'galaxy s22 ultra 5g (usa unlocked)', 'galaxy s22 ultra 5g (usa)', 'galaxy s22 ultra 5g (china)', 'galaxy s22 ultra 5g (korea)', 'galaxy s22 ultra 5g (canada)' => 'Galaxy S22 Ultra',
            ...
            'galaxy tab s6 lite 10.4"', 'galaxy tab s6 lite 10.4" wifi', 'galaxy tab s6 lite 10.4" wi-fi (2024)', 'galaxy tab s6 lite 10.4" wi-fi (2022)', 'galaxy tab s6 lite 10.4" lte (2022)', 'galaxy tab s6 lite 10.4" lte' => 'Galaxy Tab S6 Lite 10.4"',

...
final class DeviceMarketingnameMapper
{
    ...
    public function mapDeviceMarketingName(string | null $marketingName): string | null
    {
        ...
        return match (mb_strtolower($marketingName)) {
            ...
            'galaxy s10', 'galaxy s10 (global)' => 'Galaxy S10',
            'galaxy s10+', 'galaxy s10+ dual sim (global)' => 'Galaxy S10+',
            ...
            'galaxy s22 ultra', 'galaxy s22 ultra 5g (international)', 'galaxy s22 ultra 5g (asia/africa)', 'galaxy s22 ultra 5g (usa unlocked)', 'galaxy s22 ultra 5g (usa)', 'galaxy s22 ultra 5g (china)', 'galaxy s22 ultra 5g (korea)' => 'Galaxy S22 Ultra',

...
final class DeviceMarketingnameMapper
{
    ...
    public function mapDeviceMarketingName(string | null $marketingName): string | null
    {
        ...
        return match (mb_strtolower($marketingName)) {
            ...
            'galaxy core 2', 'galaxy core 2 duos (latin)' => 'Galaxy Core 2',
            ...
            'galaxy note 4', 'galaxy note 4 lte (europe)', 'galaxy note 4 lte (t-mobile)', 'galaxy note 4 cdma (verizon)', 'galaxy note 4 cdma (at&t)' => 'Galaxy Note 4',

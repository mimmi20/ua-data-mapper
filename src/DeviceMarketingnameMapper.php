...
final class DeviceMarketingnameMapper
{
    ...
    public function mapDeviceMarketingName(string | null $marketingName): string | null
    {
        ...
        return match (mb_strtolower($marketingName)) {
            ...
            'galaxy note 20 ultra 5g', 'galaxy note 20 ultra 5g (international)', 'galaxy note 20 ultra 5g (china)', 'galaxy note 20 ultra 5g (usa)', 'galaxy note 20 ultra 5g (usa, unlocked)' => 'Galaxy Note 20 Ultra 5G',
            'galaxy note pro 12.2" lte', 'galaxy notepro 12.2" lte' => 'Galaxy Note Pro 12.2" LTE',
            'galaxy pocket 2' => 'Galaxy Pocket 2',
            'galaxy grand prime', 'galaxy grand prime value edition lte', 'galaxy grand prime lte', 'galaxy grand prime duos' => 'Galaxy Grand Prime',

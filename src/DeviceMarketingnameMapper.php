...
final class DeviceMarketingnameMapper
{
    ...
    public function mapDeviceMarketingName(string | null $marketingName): string | null
    {
        ...
        return match (mb_strtolower($marketingName)) {
            ...
            'galaxy note 4', 'galaxy note 4 lte (europe)', 'galaxy note 4 lte (t-mobile)', 'galaxy note 4 cdma (verizon)', 'galaxy note 4 cdma (at&t)', 'galaxy note 4 lte (singapore, india, australia)', 'galaxy note 4 lte (korea)' => 'Galaxy Note 4',

...
final class BrowserNameMapper
{
    ...
    public function mapBrowserName(string | null $browserInput): string | null
    {
        ...
        return match (mb_strtolower($browserInput)) {
            ...
            'firefox mobile', 'mobile firefox mobile', 'mobile firefox tablet', 'mobile firefox', 'firefox mobile for ios', 'firefox mobile ios', 'firefox for ios', 'firefox ios', 'fxios', 'chimera' => 'Firefox',
            ...
            'adbeat bot', 'adbeat', 'adbeat publisher description fetcher' => 'Adbeat Bot',
            'quark', 'quarkpc' => 'Quark',
            'norton secure browser', 'norton private browser' => 'Norton Secure Browser',
            'daum app', 'daum', 'edacious & intelligent web robot', 'daum rss robot' => 'Daum',
            ...
            'netcraft survey agent', 'netcraft survey bot', 'netcraft webserver survey', 'netcraft ssl server survey' => 'Netcraft Survey Agent',
            'optimizer bot', 'sistrix optimizer' => 'Optimizer Bot',
            'go httpclient', 'go-http-client' => 'GO HttpClient',
            'duckduck bot', 'duckduckbot', 'duckduck favicons bot' => 'DuckDuck Bot',
            ...
            'internet archive', 'archive.org bot', 'internet archive special archiver' => 'Internet Archive',
            ...
            'yahoo! japan', 'yahoo! japan bot', 'yahoo! japan app', 'yahoo! japan bro', 'yahoo! japan wsc', 'yahoo! japan asr', 'yahoo! japan psc', 'yahoo! japan brw', 'yahoo! japan bri', 'yahoo! japan bsc', 'yahoo! japan brj', 'yahoo! robot study', 'yahoo! japan bry' => 'Yahoo! Japan',
            ...
            'winhttp', 'winhttp winhttprequest', 'windows http' => 'WinHttp',
            ...
            'feedly', 'feedly feed fetcher', 'feedlybot' => 'Feedly',
            ...
            'yandex favicons bot', 'yandexfavicons' => 'Yandex Favicons Bot',
            ...
            'femtosearchbot', 'femtosearch' => 'FemtosearchBot',
            'w3c i18n checker' => 'W3C I18n Checker',
            'w3c unified validator', 'w3c unicorn' => 'W3C Unified Validator',
            'vortex' => 'Vortex',
            'ltx71 bot', 'ltx71' => 'ltx71 Bot',
            'slackbot', 'slackbot-link-expanding', 'slack imgage proxy' => 'Slackbot',
            'pocket', 'pocketparser', 'pocketimagecache' => 'Pocket',
            'freewebmonitoring', 'freewebmonitoring sitechecker' => 'FreeWebMonitoring',
            ...
            'omgili bot', 'omgilibot' => 'Omgili Bot',
            'abonti websearch', 'abonti' => 'Abonti WebSearch',
            'automattic analytics crawler', 'automattic analytics' => 'Automattic Analytics Crawler',
            'w3c css validator', 'jigsaw css validator' => 'W3C CSS Validator',
            'crowdtanglebot', 'crowdtangle' => 'CrowdTangleBot',
            ...
            'awariobot', 'awario', 'awariosmartbot', 'awariorssbot' => 'AwarioBot',
            ...
            'songbird', 'songbird app' => 'Songbird',
            ...
            'otter', 'otter browser' => 'Otter',
            'maxthon nitro', 'mxnitro' => 'Maxthon Nitro',
            'microsoft lync', 'lync' => 'Microsoft Lync',

...
final class BrowserNameMapper
{
    ...
    public function mapBrowserName(string | null $browserInput): string | null
    {
        ...
        return match (mb_strtolower($browserInput)) {
            ...
            'yahoo! japan', 'yahoo! japan bot', 'yahoo! japan app', 'yahoo! japan bro', 'yahoo! japan wsc', 'yahoo! japan asr', 'yahoo! japan psc', 'yahoo! japan brw', 'yahoo! japan bri', 'yahoo! japan bsc', 'yahoo! japan brj', 'yahoo! robot study' => 'Yahoo! Japan',

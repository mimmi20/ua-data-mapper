...
final class BrowserNameMapper
{
    ...
    public function mapBrowserName(string | null $browserInput): string | null
    {
        ...
        return match (mb_strtolower($browserInput)) {
            ...
            'googlebot', 'google bot mobile', 'adsbot google-mobile', 'adsbot google', 'google web preview', 'google read aloud', 'google publisher wordpress plugin', 'google web snippet', 'google ads conversions', 'google ads qualify' => 'Google Bot',
